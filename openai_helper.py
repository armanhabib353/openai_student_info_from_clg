...
if __name__ == '__main__':
    # print(get_answer("What was Arman's GPA in semester 1?"))
    # print(get_answer("average gpa in third semester?"))
    # print(get_answer("how much is Arman's pending fees in the first semester?"))
    print(get_answer("how much was Arman's due fees in the first semester?"))
